...
function run_7zip_benchmark() {
	...
	COMPRESS_SPEED=$(echo "$BENCHMARK_RESULT" | grep "AVG Compress speed" | awk '{print $4, $5}')
	DECOMPRESS_SPEED=$(echo "$BENCHMARK_RESULT" | grep "AVG Decompress speed" | awk '{print $4, $5}')
